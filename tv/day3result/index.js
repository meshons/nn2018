...
function updates() {
  // newbie
  console.log('up');
  $.getJSON('../backend/day3/getnewbie.php?v=' + newbiever, function (data) {
  ...
  //});
  // update
  $.getJSON('../backend/day3/getupdate.php?v=' + updatever, function (data) {
  ...
  // delete
  $.getJSON('../backend/day3/getdelete.php?v=' + deletever, function (data) {
    $.each(data, function (key, val) {
...
$(document).ready(function () {
  ...
  $.getJSON('../backend/day3/getvers.php', function (data) {
    if (data['newbie'] != null) newbiever = parseInt(data['newbie'], 10) + 1;
    console.log(newbiever);
  ...
  $.getJSON('../backend/getcate.php?s=0', function (data) {
    $.each(data, function (key, val) {
      ...
      $.getJSON(
        '../backend/day3/runnerfromcat.php?cat=' + val.cat,
        function (data) {
