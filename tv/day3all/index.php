...
<body>
    ...
    <?php
            ...
            while($r = mysqli_fetch_assoc($sth)) {
                ...
                $i = 1;
                $first = "";
                $sth2 = mysqli_query($con,"SELECT lastname,firstname,club,nap_3.time,nap_1.time+nap_2.time+nap_3.time AS alltime FROM futok INNER JOIN nap_1 ON futok.id = nap_1.id INNER JOIN nap_2 ON futok.id=nap_2.id INNER JOIN nap_3 ON futok.id = nap_3.id WHERE category='".$r["cat"]."' AND nap_1.status=0 AND nap_2.status=0 AND nap_3.status=0 ORDER BY alltime");
                 ...
                 $sth3 = mysqli_query($con,"SELECT lastname,firstname,club,nap_3.time FROM futok INNER JOIN nap_1 ON futok.id = nap_1.id INNER JOIN nap_3 ON futok.id = nap_3.id INNER JOIN nap_2 ON futok.id=nap_2.id WHERE category='".$r["cat"]."' AND (nap_1.status<>0 OR nap_2.status<>0) AND nap_3.status=0 ORDER BY nap_3.time");
